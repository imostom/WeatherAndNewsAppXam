...
namespace WeatherAppXam.Services
{
    public class CryptographyUtil
    {
        ...
        public static string EncryptText(string input, string password, string saltString)
        {
            //convert saltString to bytes
        ...
        public static string DecryptText(string input, string password, string saltString)
        {
            //convert saltString to bytes
            var saltBytes = Convert.FromBase64String(saltString);
